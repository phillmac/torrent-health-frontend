...
<html lang="en">
    ...
    <!--
        ...
        print_r(
            array (
                '$test' => $test,
                'count' => count([1622009568,1622010229,1622010306,1622010572,1622011057,1622011357,1622011730,1622012300,1622012383,1622012392,1622012536,1622012907,1622013025])
            )    
        );
       ?>
    -->
